...
import { Avatar, SurfaceCard } from "../components/common";
    ...
    <div className="min-h-full flex flex-col" style={{ background: "var(--bg-app)" }}>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-6">
        <SurfaceCard className="relative w-full max-w-md overflow-hidden">
          {/* Тёплый градиентный фон: peach → светлый, чтобы бейдж читался
              и как «парадная» карточка, и как фон под тёмным ФИО/аватаром. */}
          <div
            aria-hidden
            className="absolute inset-0"
            style={{
              background:
                "linear-gradient(180deg, var(--accent-peach) 0%, rgba(255,255,255,0.9) 60%, rgba(255,255,255,0.75) 100%)",
            }}
          />
