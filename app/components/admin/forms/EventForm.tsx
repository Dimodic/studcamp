  ...
  return (
    <>
      <TextField
        ...
        type="date"
        value={state.date}
        onChange={(value) => onChange({ ...state, date: value })}
      />
      <TextField
        label="Название"
        value={state.title}
      ...
      <div className="grid grid-cols-2 gap-3">
        <TextField
          label="Начало"
          value={state.startAt}
          onChange={(value) => onChange({ ...state, startAt: value })}
          placeholder="09:00"
        />
        <TextField
          label="Конец"
          value={state.endAt}
          onChange={(value) => onChange({ ...state, endAt: value })}
          placeholder="10:30"
        />
      </div>
      <TextField
        label="Место"
        value={state.place}
        onChange={(value) => onChange({ ...state, place: value })}
      />
      <TextField
        label="Корпус / площадка"
      ...
      <TextField
        label="Адрес"
        value={state.address}
        onChange={(value) => onChange({ ...state, address: value })}
      />
      <SelectField
        label="Статус"
        value={state.status}
